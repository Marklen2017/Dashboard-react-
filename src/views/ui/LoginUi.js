...
import React, { Suspense, BrowserRouter } from "react";
  ...
  const fetchData = async (data) => {
    try {
      const response = await fetch(
        "https://twitter-api-2406.herokuapp.com/auth/login/",
        {
          ...
          headers: {
            ...
            "X-Csrftoken":
              "taLOvDWaPQakSNX895bxm9UA8MwICT4H5Jp1SywlEezWdfhhO2I3OpKiV5yrnF4o",
          },
          method: "POST",
        }
      );
