  ...
  return (
    <form className="search-form" onSubmit={handleSubmit(onSubmit)}>
      ...
      <div
        ...
        style={ searchState ? { display: "flex", flexWrap: "wrap"} : { display:'none'}}
      ...
      >
        ...
        <div className="btn-flex-tweet">
            ...
            <button style={{ height: '48px' }} className="btn-next" onClick={() => tweetNext()}><span>Next </span></button>
        </div>
           ...
           <div className="media-flex">
               ...
               <div className="media-checkbox-flex">
                   <div style={{ padding: '12px 0px' }} className="label">tipe
                       <div className="media-no-flex"><div className="no-check">Request</div>
                       <input style={{ height: '28px' }} className="input-checkbox" type="checkbox" checked={checkTipe.checked} onChange={(event) => checkTipe.handlerCheck(event)}/></div>
                   </div>
                   <div style={{ padding: '12px 0px' }} className="label">preview_image_url
                       <div className="media-no-flex-1">
                         <input style={{ height: '28px' }} className="checkbox-2" type="checkbox" checked={checkPreview.checked} onChange={(event) => checkPreview.handlerCheck(event)} /></div>
                   </div>
                   <div style={{ padding: '12px 0px' }} className="label">url
                       <div style={{ margin: '0px 174px' }} className="media-no-flex-1">
                       <input style={{ height: '28px' }} className="checkbox-2" type="checkbox" checked={checkUrl.checked} onChange={(event) => checkUrl.handlerCheck(event)} /></div>
                   </div>
                   <div style={{ padding: '12px 0px' }} className="label">duration_ms
                       <div style={{ margin: '0px 69px' }} className="media-no-flex-1">
                       <input style={{ height: '28px' }} className="checkbox-2" type="checkbox" checked={checkDuration.checked} onChange={(event) => checkDuration.handlerCheck(event)} /></div>
                   </div>
                   <div style={{ padding: '12px 0px' }} className="label">public_metrics
                       <div style={{ margin: '0px 47px' }} className="media-no-flex-1">
                       <input style={{ height: '28px' }} className="checkbox-2" type="checkbox" checked={checkPublic.checked} onChange={(event) => checkPublic.handlerCheck(event)} /></div>
                   </div>
                   <div style={{ padding: '12px 0px' }} className="label">alt_text
                       <div style={{ margin: '0px 122px' }} className="media-no-flex-1">
                       <input style={{ height: '28px' }} className="checkbox-2" type="checkbox" checked={checkAlt.checked} onChange={(event) => checkAlt.handlerCheck(event)} /></div>
                   </div>
               </div>
               <div style={{ fontSize: '24px', color: '#697184', padding: '44px 0px 0px 0px' }}>
                   <p>Default Objects:</p>
           ...
           <div className="media-flex-1">
               ...
               <div className="media-checkbox-flex">
                   <div style={{ padding: '12px 0px' }} className="label">country
                       <div className="media-no-flex"><div className="no-check">Request</div>
                       <input style={{ height: '28px' }} className="input-checkbox" type="checkbox" checked={checkCountry.checked} onChange={(event) => checkCountry.handlerCheck(event)} /></div>
                   </div>
                   <div style={{ padding: '12px 0px' }} className="label">country_code
                       <div style={{ margin: '0px 10px 0px 100px' }} className="media-no-flex-1">
                       <input style={{ height: '28px' }} className="checkbox-2" type="checkbox" checked={checkCountryCode.checked} onChange={(event) => checkCountryCode.handlerCheck(event)} /></div>
                   </div>
                   <div style={{ padding: '12px 0px' }} className="label">geo
                       <div style={{ margin: '0px 10px 0px 203px' }} className="media-no-flex-1">
                         <input style={{ height: '28px' }} className="checkbox-2" type="checkbox" checked={checkGeo.checked} onChange={(event) => checkGeo.handlerCheck(event)}/></div>
                   </div>
                   <div style={{ padding: '12px 0px' }} className="label">name
                       <div style={{ margin: '0px 10px 0px 184px' }} className="media-no-flex-1">
                         <input style={{ height: '28px' }} className="checkbox-2" type="checkbox" checked={checkName.checked} onChange={(event) => checkName.handlerCheck(event)}/></div>
                   </div>
                   <div style={{ padding: '12px 0px' }} className="label">place_type
                       <div style={{ margin: '0px 10px 0px 127px' }} className="media-no-flex-1">
                         <input style={{ height: '28px' }} className="checkbox-2" type="checkbox" checked={checkPlaceType.checked} onChange={(event) => checkPlaceType.handlerCheck(event)}/></div>
                   </div>
       ...
       <div className="btn-flex-tweet">
           ...
           <button style={{ height: '48px' }} className="btn-next" onClick={() => expansionsNext()}><span>Next </span></button>
       </div>
        ...
        <div className="tweet-page"  style={ expansionsState ? {} : { display:'none'}}>
      <div className="tweet-title">
