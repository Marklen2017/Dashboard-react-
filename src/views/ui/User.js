            ...
            <div className="user-checkbox-flex">
              ...
              <div className="label">
                ...
                <div className="no-flex">
                  <div className="no-check">Yes</div>
                  <input
                    style={{ height: "28px" }}
              ...
              <div className="label-1">
                description
                <div style={{ display: "flex" }} className="user-no-flex">
                  <input
                    style={{ height: "28px" }}
              ...
              <div className="label-1">
                ...
                <div style={{ display: "flex" }} className="user-no-flex">
                  <input
                    ...
                    type="checkbox"
                  />
                  <p>Details about text in a users description</p>
                </div>
              </div>
              <div className="label-1">
                Location (Long/Lat)
              ...
              <div className="label-1">
                ...
                <div style={{ display: "flex" }} className="user-no-flex">
                  <input
                    ...
                    type="checkbox"
                  />
                  <p>Info if users tweets are private</p>
                </div>
              </div>
              <div className="label-1">
                public_metrics
                <div style={{ display: "flex" }} className="user-no-flex">
                  <input
                    ...
                    type="checkbox"
                  />
                  <p>Contains details about activity for this users.</p>
                </div>
              </div>
              <div className="label-1">
                verified
              ...
              <div className="label-1">
                ...
                <div style={{ display: "flex" }} className="user-no-flex">
                  <input
                    ...
                    type="checkbox"
                  />
                  <p>Tweet id of users pinned tweet</p>
                </div>
              </div>
              <div className="label-1">
                url
                <div style={{ display: "flex" }} className="user-no-flex">
                  <input
                    ...
                    type="checkbox"
                  />
                  <p>Users profile URL</p>
                </div>
              </div>
            </div>
            <div className="user-part-right">
              <h4 style={{ fontSize: "24px", color: "#697184" }}>
                Default Objects:
              </h4>
